...
public class OtherAPKTests extends JUnitTests {
	...
	public void runTest1() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("testAPKs/9458cfb51c90130938abcef7173c3f6d44a02720.apk", false, false,
				false);
	...
	public void runTest2() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("testAPKs/enriched1.apk", false, false, false);
		Assert.assertNotNull(res);
	...
	public void runReturnParameterTest() throws IOException, XmlPullParserException {
		InfoflowResults res = analyzeAPKFile("testAPKs/ReturnParameterTest.apk", false, false, false);
